...
urlpatterns = [
    ...
    path(
        'dashboard/apps/<uuid:app_unique_id>/payments/new',
        PaymentCreateView.as_view(),
        name='app_detail_payments_create'
    ),
    path(
        'dashboard/apps/<uuid:app_unique_id>/payments/<uuid:payment_unique_id>/edit',
        PaymentEditView.as_view(),
        name='app_detail_payments_edit'
    ),
    path(
        'dashboard/apps/<uuid:app_unique_id>/payments/<uuid:payment_unique_id>/archive',
        PaymentArchiveView.as_view(),
        name='app_detail_payments_archive'
    ),
    # Plan model views
    path(
    ...
    path(
        'dashboard/apps/<uuid:app_unique_id>/plans/<uuid:plan_unique_id>/subscriptions/<uuid:plan_instance_unique_id>/archive',
        PlanInstanceArchiveView.as_view(),
        name='app_detail_plan_planinstance_archive'
    ),
    path(
